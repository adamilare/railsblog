...
- Creating database migration files, and using them to maintain database schema
- Understanding ORM in Rails development
...
```
  git clone https://github.com/adamilare/railsblog.git
  cd blog-app-rail
```
